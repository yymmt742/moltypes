...
if [ "x$DOAUTOTOOL" = "xTRUE" ]; then
    ...
    if [ "x$DOACTION" = "xbuild" ]; then
        ...
        LIBS="-lm -lhdf5_hl -lhdf5 -lz -lsz -lcurl" CFLAGS="-I/home/yamamoto/local/devel/github/moltypes/include" LDFLAGS="-L/home/yamamoto/local/devel/github/moltypes/lib" ./configure --prefix=/home/yamamoto/local/devel/github/moltypes $STATIC_BUILD $SHARED_BUILD
        LIBS="-lm -lhdf5_hl -lhdf5 -lz -lsz -lcurl" make
        LIBS="-lm -lhdf5_hl -lhdf5 -lz -lsz -lcurl" make check
    fi
